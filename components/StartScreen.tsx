...
const StartScreen = ({ onStart, highScore }: StartScreenProps) => {
  return (
    <div className="w-full h-full flex flex-col items-center justify-center bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center px-6 max-w-2xl">
        ...
        <div className="mb-8 text-center">
          <h1 className="text-7xl md:text-8xl font-black text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 via-red-500 to-pink-500 mb-4 animate-pulse-fast">
            TURBO
          </h1>
          <h2 className="text-5xl md:text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500">
            RACER
          </h2>
        </div>
        ...
        {/* High Score */}
        {highScore > 0 && (
          <div className="mb-8 bg-black/40 backdrop-blur-md px-8 py-4 rounded-2xl border-2 border-yellow-400 shadow-xl">
        ...
        <button
          onClick={onStart}
          className="group relative px-12 py-5 bg-gradient-to-r from-green-400 to-emerald-500 text-white font-black text-2xl rounded-full shadow-2xl hover:shadow-green-500/50 transform hover:scale-105 transition-all duration-200 mb-8"
        >
        ...
        {/* Instructions */}
        <div className="bg-black/30 backdrop-blur-sm px-8 py-6 rounded-2xl border border-white/20 shadow-xl max-w-md">
          <h3 className="text-white font-bold text-xl mb-4 text-center">How to Play</h3>
